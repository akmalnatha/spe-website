              ...
              <>
                ...
                <div className="flex flex-row border-t-8 border-[#1F3576] p-11 justify-center items-center gap-8">
                  <img
                    src={elem.image}
                    alt={elem.alt}
                    className="w-[344px] h-auto object-cover"
                  />
                  <div className="w-1/2 flex flex-col gap-6 px-16">
                    ...
                    <Link
                      href={elem.link}
                      className="w-fit h-fit text-[#142B6F] font-bold font-poppins text-2xl items-end bg-[#FAD133] rounded-3xl px-6 py-2"
                    >
                      Read For More
                    </Link>
                  </div>
              ...
              <>
                ...
                <div className="flex flex-row border-t-8 border-[#1F3576] p-11 justify-center items-center gap-8">
                  <div className="w-1/2 flex flex-col gap-4 px-16">
                    ...
                    <Link
                      href={elem.link}
                      className="w-fit h-fit text-[#142B6F] font-bold font-poppins text-2xl justify-end items-end bg-[#FAD133] rounded-3xl px-6 py-2"
                    >
                      Read For More
                    </Link>
                  </div>
